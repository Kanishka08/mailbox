...
const ComposeMail = () => {
  ...
  const submitHandler = (event) => {
    ...
    axios.post(
      `https://mailbox-client-15225-default-rtdb.firebaseio.com/mails/${userId}sentbox.json`,
      mailDetails
    );
    axios
      .post(
        `https://mailbox-client-15225-default-rtdb.firebaseio.com/mails/${reciever}inbox.json`,
        mailDetails
      )
